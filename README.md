...
| 版本 | 功能 |
|------|------|
| **1.3.0** | 🗄️ **IndexedDB 持久化缓存** — 跨重启缓存，mtime 指纹增量更新；零 I/O 加载（用 metadataCache）；批量 I/O 优化；精简 Cell 组件去 Zustand 订阅 |
...
| Version | Feature |
|---------|---------|
| **1.3.0** | 🗄️ **IndexedDB persistent cache** — Survives restarts, mtime-based incremental updates; Zero-I/O mode via metadataCache; Batch I/O optimization; Stripped Zustand subscriptions from cells |
